...
type Poi struct {
	...
	Detail     string  `db:"detail"  json:"detail" gorm:"type:varchar(255)"`
	TypeID     string  `db:"type_id"  json:"type_id" gorm:"type:varchar(2)"`
	...
	Status    string  `db:"status"  json:"status" gorm:"bit"`
}
